...
import {
  Email, Lock, Visibility, VisibilityOff, Agriculture,
      ...
      <Card sx={{ width: '100%', maxWidth: 420 }}>
        <CardContent sx={{ p: 4 }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 3.5 }}>
            ...
            <Typography variant="h5" fontWeight={700}>Seed</Typography>
            <Typography variant="body2" color="text.secondary" mt={0.5}>Đăng nhập hệ thống đo mẫu</Typography>
          </Box>
          ...
          <Typography variant="body2" align="center" mt={3} color="text.secondary">
            Chưa có tài khoản?{' '}
            <Link to="/register" style={{ color: '#2F6B4F', textDecoration: 'none', fontWeight: 600 }}>
              Đăng ký
            </Link>
          </Typography>
        </CardContent>
